...
class SettingsPurchaseScreen extends StatefulWidget {
  @override
  _SettingsPurchaseScreenState createState() => _SettingsPurchaseScreenState();
}

class _SettingsPurchaseScreenState extends State<SettingsPurchaseScreen> {
  SettingsPurchaseRepository? repo;

  @override
  void didChangeDependencies() {
    
    super.didChangeDependencies();
    repo = Provider.of<SettingsPurchaseRepository>(context);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Purchase Settings".tr),
      ),
      body: ListView(
        children: [
          /*CheckboxListTile(
