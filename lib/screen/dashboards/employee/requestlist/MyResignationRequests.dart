...
class MyResignationRequests extends StatefulWidget {
  String element;

  MyResignationRequests(this.element);

  @override
  _MyResignationRequestsState createState() => _MyResignationRequestsState();
}

class _MyResignationRequestsState extends State<MyResignationRequests> {
  List? list;
            ...
            ? ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return RequestItem(
                    ...
                    onTap: (){
                      String url="hrm/requestresignationaprooval";
  ...
  Future getRequestList() async {
    var url = MyKey.baseUrl + "hrm/resignationrequest/list";
