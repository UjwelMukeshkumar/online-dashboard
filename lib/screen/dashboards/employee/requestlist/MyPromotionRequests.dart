...
class MyPromotionRequests extends StatefulWidget {
  String element;

  MyPromotionRequests(this.element);

  @override
  _MyPromotionRequestsState createState() => _MyPromotionRequestsState();
}

class _MyPromotionRequestsState extends State<MyPromotionRequests> {
  List? list;
            ...
            ? ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return RequestItem(
                    ...
                    subTitle:
                        "${item["Designation"]} - ${item["ToDesignation"]}",
                    trailing1: "${item["CreatedDate"]}",
                    trailing2: "${item["ApprovalLevel"]}",
                    onTap: () {
                      String url = "hrm/requestpromotionaprooval";
  ...
  Future getRequestList() async {
    var url = MyKey.baseUrl + "hrm/promotionrequest/list";
    Map params = {
