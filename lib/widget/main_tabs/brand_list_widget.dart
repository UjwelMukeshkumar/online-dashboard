...
import 'package:glowrpt/screen/dashboards/sales/fulllist/brand_list_screen.dart';
...
class _BrandListWidgetState extends State<BrandListWidget>
      ...
      children: [
         ...[
          DaysSelectorWidget(
            ...
            intialText: dateRangeText??"defualt text",
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text("No of Brands", style: textTheme.overline),
                ),
                Padding(
                  padding:
                      const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
  ...
  Future<void> updateLines() async {
    ...
    if (settings!.category) {
      var data = await Serviece.getBarandDetails(
          ...
          FromDate:dateListLine==null?""  :dateListLine!.first,
          ToDate: dateListLine==null?"": dateListLine!.last,
  ...
  void openBarandScreen() {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => BrandListScreen(isSale: widget.isSale,dateListLine: dateListLine,dateRangeText: dateRangeText,)));
  }
}
