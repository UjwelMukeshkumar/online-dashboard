...
//
//     final distanceM = distanceMFromJson(jsonString);

import 'dart:convert';

DistanceM distanceMFromJson(String str) => DistanceM.fromJson(json.decode(str));

String distanceMToJson(DistanceM data) => json.encode(data.toJson());
...
class DistanceM {
  ...
  factory DistanceM.fromJson(Map<String, dynamic> json) => DistanceM(
