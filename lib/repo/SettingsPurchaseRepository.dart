...
class SettingsPurchaseRepository with ChangeNotifier {
  String _section = "puchase section";
  String _category = "puchase category";
  String _whatChangedSince = "puchase whatChangedSince";
  String _menuItems = "puchase menuItems";
  String _scanbarCode = "puchase scanbarCode";
  String _Sales = "puchase Sales";
  String _SalesOrder = "puchase Sales Order";
  String _SalesReturn = "puchase Sales Return";
  String _Purchase = "puchase Purchase";
  String _PurchaseOrder = "puchase Purchase Order";
  String _PurchaseReturn = "puchase Purchase Return";
  String _POS = "puchase POS";
  String _POSOrder = "puchase POS Order";
  String _POSReturn = "puchase POS Return";
  String _Lossreport = "puchase Loss report";
  String _CreditSale = "puchase Credit Sale";
  String _Receivable = "puchase Receivable";
  String _Payable = "puchase Payable";
  String _ManualJournal = "puchase Manual Journal";
  String _CategoryStock = "puchase Category Stock";
  String _CashandBank = "puchase Cash and Bank";
  String _CounterClosing = "puchase Counter Closing";
  String _DayBook = "puchase Day Book";
  String _CashFlow = "puchase Cash Flow";
  String _TrialBalance = "puchase Trial Balance";
  String _ProfitAndLoss = "puchase Profit & Loss";
  String _Accountpayments = "puchase Account payments";
  String _Accountreceipts = "puchase Account receipts";
  String _Payments = "puchase Payments";
  String _Receipts = "puchase Receipts";
  String _LiquidityScor = "puchase Liquidity Score";
  String _FinancialDashBoar = "puchase Financial DashBoard";
  String _DebitCreditAnalysi = "puchase Debit Credit Analysis";
  String _CashConventionCycl = "puchase Cash Convention Cycle";
  String _ProfitRatio = "puchase Profit Ratio";

  SharedPreferences pref;

  SettingsPurchaseRepository(this.pref);
