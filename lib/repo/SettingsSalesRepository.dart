...
class SettingsSalesRepository with ChangeNotifier {
  String _section = "sales section";
  String _category = "sales category";
  String _whatChangedSince = "sales whatChangedSince";
  String _menuItems = "sales menuItems";
  String _scanbarCode = "sales scanbarCode";
  String _Sales = "sales Sales";
  String _SalesOrder = "sales Sales Order";
  String _SalesReturn = "sales Sales Return";
  String _Purchase = "sales Purchase";
  String _PurchaseOrder = "sales Purchase Order";
  String _PurchaseReturn = "sales Purchase Return";
  String _POS = "sales POS";
  String _POSOrder = "sales POS Order";
  String _POSReturn = "sales POS Return";
  String _Lossreport = "sales Loss report";
  String _CreditSale = "sales Credit Sale";
  String _Receivable = "sales Receivable";
  String _Payable = "sales Payable";
  String _ManualJournal = "sales Manual Journal";
  String _CategoryStock = "sales Category Stock";
  String _CashandBank = "sales Cash and Bank";
  String _CounterClosing = "sales Counter Closing";
  String _DayBook = "sales Day Book";
  String _CashFlow = "sales Cash Flow";
  String _TrialBalance = "sales Trial Balance";
  String _ProfitAndLoss = "sales Profit & Loss";
  String _Accountpayments = "sales Account payments";
  String _Accountreceipts = "sales Account receipts";
  String _Payments = "sales Payments";
  String _Receipts = "sales Receipts";
  String _LiquidityScor = "sales Liquidity Score";
  String _FinancialDashBoar = "sales Financial DashBoard";
  String _DebitCreditAnalysi = "sales Debit Credit Analysis";
  String _CashConventionCycl = "sales Cash Convention Cycle";
  String _ProfitRatio = "sales Profit Ratio";

  SharedPreferences pref;

  SettingsSalesRepository(this.pref);
